import 'models/orange_model.dart';
import 'package:flutter/material.dart';
import 'package:stefanus_s_application1/core/app_export.dart';
import 'provider/orange_provider.dart';
...
class OrangeScreen extends StatefulWidget {
  ...
  @override
  OrangeScreenState createState() => OrangeScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => OrangeProvider(), child: OrangeScreen());
  }
}

class OrangeScreenState extends State<OrangeScreen> {
    ...
    return SizedBox(
        ...
        child: Stack(alignment: Alignment.bottomCenter, children: [
          Align(
              ...
              child:
                  Text("lbl_ce_25".tr, style: CustomTextStyles.interOrange500)),
          Align(
