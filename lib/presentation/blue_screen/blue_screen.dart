...
class BlueScreen extends StatefulWidget {
  ...
  @override
  BlueScreenState createState() => BlueScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => BlueProvider(), child: BlueScreen());
  }
}

class BlueScreenState extends State<BlueScreen> {
    ...
    return SizedBox(
        ...
        child: Stack(alignment: Alignment.bottomCenter, children: [
          Align(
              ...
              child: Text("lbl_ce_25".tr,
                  style: CustomTextStyles.interDeeppurple900)),
          Align(
              alignment: Alignment.bottomCenter,
              child: Container(
                  height: 25.v,
                  width: 322.h,
                  decoration: BoxDecoration(color: appTheme.deepPurple900)))
        ]));
  }
