import 'models/purple_model.dart';
import 'package:flutter/material.dart';
import 'package:stefanus_s_application1/core/app_export.dart';
import 'provider/purple_provider.dart';
...
class PurpleScreen extends StatefulWidget {
  ...
  @override
  PurpleScreenState createState() => PurpleScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => PurpleProvider(), child: PurpleScreen());
  }
}

class PurpleScreenState extends State<PurpleScreen> {
    ...
    return SizedBox(
        ...
        child: Stack(alignment: Alignment.bottomCenter, children: [
          Align(
              ...
              child:
                  Text("lbl_ce_25".tr, style: CustomTextStyles.interPurple800)),
          Align(
              alignment: Alignment.bottomCenter,
              child: Container(
                  height: 25.v,
                  width: 322.h,
                  decoration: BoxDecoration(color: appTheme.purple800)))
        ]));
  }
