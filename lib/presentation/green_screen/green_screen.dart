...
class GreenScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => GreenProvider(), child: GreenScreen());
  }
}
        ...
        child: Stack(alignment: Alignment.bottomCenter, children: [
          Align(
              ...
              child: Text("lbl_ce_25".tr,
                  style: CustomTextStyles.interGreen90002)),
          Align(
              alignment: Alignment.bottomCenter,
              child: Container(
                  height: 25.v,
                  width: 322.h,
                  decoration: BoxDecoration(color: appTheme.green90002)))
        ]));
  }
