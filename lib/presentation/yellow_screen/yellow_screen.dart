import 'models/yellow_model.dart';
import 'package:flutter/material.dart';
import 'package:stefanus_s_application1/core/app_export.dart';
import 'provider/yellow_provider.dart';
...
class YellowScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => YellowProvider(), child: YellowScreen());
  }
}
        ...
        child: Stack(alignment: Alignment.bottomCenter, children: [
          Align(
              ...
              child: Text("lbl_ce_25".tr,
                  style: CustomTextStyles.interYellowA200)),
          Align(
              alignment: Alignment.bottomCenter,
              child: Container(
                  height: 25.v,
                  width: 322.h,
                  decoration: BoxDecoration(color: appTheme.yellowA200)))
        ]));
  }
